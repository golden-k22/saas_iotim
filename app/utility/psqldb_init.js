...
module.exports = async function initDB() {    
    db.sequelize.query("Drop TABLE IF EXISTS gateway")   
    db.sequelize.query("Drop TABLE IF EXISTS devices")  
    db.sequelize.query("Drop TABLE IF EXISTS alarms")  
    db.sequelize.query("Drop TABLE IF EXISTS report")
